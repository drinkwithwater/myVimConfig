...
call s:initVariable("g:NERDTreeMapChangeRoot", "i")
...
call s:initVariable("g:NERDTreeMapJumpNextSibling", "<C-h>")
call s:initVariable("g:NERDTreeMapJumpParent", "p")
call s:initVariable("g:NERDTreeMapJumpPrevSibling", "<C-l>")
call s:initVariable("g:NERDTreeMapJumpRoot", "P")
call s:initVariable("g:NERDTreeMapOpenExpl", "e")
call s:initVariable("g:NERDTreeMapOpenInTab", "t")
call s:initVariable("g:NERDTreeMapOpenInTabSilent", "T")
call s:initVariable("g:NERDTreeMapOpenRecursively", "O")
call s:initVariable("g:NERDTreeMapOpenSplit", "s")
...
function! s:tabPrevioustemp()
    exec ":tabp"
endfunction
function! s:tabNexttemp()
    exec ":tabn"
endfunction
function! s:closeAndOpen(target)
    let currentTabBefore=tabpagenr()
    call s:openInNewTab(a:target)
    let currentTabAfter=tabpagenr()
    exec "tabn ".string(currentTabBefore)
    call s:closeTreeIfOpen()
    exec "tabn ".string(currentTabAfter)
endfunction
"}}}"
...
function! s:createDefaultBindings()
    ...
    call NERDTreeAddKeyMap({ 'key': '<C-h>', 'scope': "all", 'callback': s."tabPrevioustemp" })
    call NERDTreeAddKeyMap({ 'key': '<C-l>', 'scope': "all", 'callback': s."tabNexttemp" })
    "call NERDTreeAddKeyMap({ 'key': '<C-j>', 'scope': "all", 'callback': s."tabMoveLeft" })
    "call NERDTreeAddKeyMap({ 'key': '<C-k>', 'scope': "all", 'callback': s."tabMoveRight" })
    call NERDTreeAddKeyMap({ 'key': '<Enter>', 'scope': "FileNode", 'callback': s."closeAndOpen" })
